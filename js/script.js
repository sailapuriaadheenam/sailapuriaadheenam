...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    if (jyothirlingaForm) {
        ...
        jyothirlingaForm.addEventListener('submit', async (e) => {
            ...
            const finalImg = fileBase64 || urlInput.value;
            ...
            // Insert into Supabase / localStorage
            try {
                if (supabaseClient) {
                    await supabaseClient.from('jyothirlinga_gallery').insert([{
                        temple_id: templeId,
                        temple_name: templeName,
                        title: title,
                        image_url: finalImg,
            ...
            alert('Photo uploaded successfully to ' + templeName + '! It is now live on the website.');
